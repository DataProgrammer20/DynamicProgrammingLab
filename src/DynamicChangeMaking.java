...
public class DynamicChangeMaking {
        ...
        for (int changeValue = 1; changeValue < coinNum.length; changeValue++) {                                            //Iterate over the data arrays
            ...
            for(int coinValue : coinTypes) {                                                                                //Check different coin Types
                int changeRemaining=changeValue-coinValue;                                                                  //Calculate the remaining change
